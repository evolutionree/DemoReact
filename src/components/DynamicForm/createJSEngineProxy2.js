  ...
  return class WithJSEngineProxy extends Component {
    ...
    constructor(props) {
      ...
      if (props.form) {
        ...
        props.form.validateFields = this.validateFieldsProxy;
      }
      this.setJS(props);
    }
    ...
    componentWillReceiveProps(nextProps) {
      if (this.props.form !== nextProps.form) {
        this.validateFields = nextProps.form.validateFields;
        nextProps.form.validateFields = this.validateFieldsProxy;
      }
    ...
    validateFieldsProxy = (...args) => {
      const fn = () => this.validateFields.apply(this.props.form, ...args);
      const loopCheck = () => {
        setTimeout(() => {
          if (!this.formSubmitLock) {
            fn();
          } else {
            loopCheck();
          }
