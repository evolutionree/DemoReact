...
class PluginAddModal extends Component {
  static propTypes = {
    ...
    currPlugin: PropTypes.shape({
      ...
      type: PropTypes.oneOf(['normal', 'flow', 'audit', 'transform', 'upatebutton', 'copybutton', 'FunctionButton'])
        .isRequired,
    ...
    return (
      <div>
        ...
        <EntcommDetailModal
          ...
          footer={[
            <Button key='cancel' type='default' onClick={this.props.cancel}>
              关闭
            </Button>,
            <Button key='ok' onClick={this.onDetailConfirm}>
              下一步
            </Button>
          ]}
        />
