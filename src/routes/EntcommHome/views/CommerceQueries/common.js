...
const columns2 = [
  ...
  // { title: '0：当前公示信息；1：历史公示信息', dataIndex: 'disabled', key: 'disabled' }
];
...
const columns3 = [
  ...
  { title: '当事人类型（0： 企业，4：社会组织，5：律所）', dataIndex: 'related_items.items.entity_type', key: 'related_items.items.entity_type' }
];
