  ...
  render() {
    return (
      <div className={Styles.SelectInputWrap}>
        <Select defaultValue="lucy" style={{ width: 120, marginRight: '4px' }} onChange={this.handleChange.bind(this)}>
          {
            this.props.data && this.props.data instanceof Array && this.props.data.map((item, index) => {
