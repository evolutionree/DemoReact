...
const appRoutes = [
  ...
  { 
    ...
    comp: ReportRelation,
    children: [
      { path: 'main', comp: ReportRelationMain, model: require('./models/reportrelation') },
      { path: 'detail/:id', comp: ReportRelationDetail, model: require('./models/reportrelationdetail') }
    ]
  },
